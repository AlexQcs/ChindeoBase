...
public class CustomDrawableSizeTextView extends AppCompatTextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.CustomDrawableSizeTextView);
        Drawable drawableL = drawable[0];

        if (drawableL != null) {
            //left
            int leftWidth = array.getDimensionPixelSize(R.styleable.CustomDrawableSizeTextView_left_width, -1);
            int leftHeight = array.getDimensionPixelSize(R.styleable.CustomDrawableSizeTextView_left_height, -1);
        ...
        if (drawableT != null) {
            int topWidth = array.getDimensionPixelSize(R.styleable.CustomDrawableSizeTextView_top_width, -1);
            int topHeight = array.getDimensionPixelSize(R.styleable.CustomDrawableSizeTextView_top_height, -1);
        ...
        //right
        if (drawableR != null) {
            int rightWidth = array.getDimensionPixelSize(R.styleable.CustomDrawableSizeTextView_right_width, -1);
            int rightHeight = array.getDimensionPixelSize(R.styleable.CustomDrawableSizeTextView_right_height, -1);
        ...
        if (drawableB != null) {
            //bottom
            int bottomWidth = array.getDimensionPixelSize(R.styleable.CustomDrawableSizeTextView_bottom_width, -1);
            int bottomHeight = array.getDimensionPixelSize(R.styleable.CustomDrawableSizeTextView_bottom_height, -1);
