 ...
 */
package com.lazylibs.util.constants;
...
public final class RegexConstants {
     ...
     */
    @Deprecated
    public static final String REGEX_IP_OLD = "((2[0-4]\\d|25[0-5]|[01]?\\d\\d?)\\.){3}(2[0-4]\\d|25[0-5]|[01]?\\d\\d?)";

    /**
     * 正则：IP 地址
     * 包含端口
     */
    public static final String REGEX_IP = "(((\\d{1,2}|1\\d\\d|2[0-4]\\d|25[0-5])\\.(\\d{1,2}|1\\d\\d|2[0-4]\\d|25[0-5])\\.(\\d{1,2}|1\\d\\d|2[0-4]\\d|25[0-5])\\.(\\d{1,2}|1\\d\\d|2[0-4]\\d|25[0-5]))(|:\\d+))";
