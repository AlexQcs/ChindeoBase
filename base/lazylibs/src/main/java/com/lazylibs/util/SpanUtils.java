...
//            LogUtils.e(fm, sfm);
    ...
    static class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        private CustomImageSpan(final Bitmap b, final int verticalAlignment) {
            ...
            activity = ActivityManager.getInstance().topOfStackActivity();
            mDrawable = new BitmapDrawable(activity.getResources(), b);
            mDrawable.setBounds(
        ...
        public Drawable getDrawable() {
            ...
            if (mDrawable != null) {
                ...
                try {
                    ...
                    if (activity != null) {
                        InputStream is = activity
                                .getContentResolver().openInputStream(mContentUri);
                ...
                try {
                    drawable = ContextCompat.getDrawable(activity, mResourceId);
                    drawable.setBounds(
                            0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight()
                    );
                } catch (Exception e) {
