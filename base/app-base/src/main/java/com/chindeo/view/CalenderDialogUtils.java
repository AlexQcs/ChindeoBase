...
/**
 * @author create by admini on 2020/2/7::45
 */
...
public class CalenderDialogUtils {
     ...
     */
    public static CalenderDialogUtils showDatePickerDialog(Context context, boolean themeLight, String title, int year, int month, int day, OnDatePickerListener onDateTimePickerListener) {
        int themeId = AlertDialog.THEME_HOLO_LIGHT;//默认白色背景
        if (!themeLight) {
            themeId = AlertDialog.THEME_HOLO_DARK;//黑色背景
        }
        return showDatePickerDialog(context, title, year, month, day, onDateTimePickerListener);
    }
     ...
     * 显示日期选择器
     */
    public static CalenderDialogUtils showDatePickerDialog(Context context, String title, int year, int month, int day,
                                                           final OnDatePickerListener onDateTimePickerListener) {
        mDatePickerDialog = new DatePickerDialog(context,R.style.dialogDate, new DatePickerDialog.OnDateSetListener() {
            @Override
        ...
        return new CalenderDialogUtils();
    }
